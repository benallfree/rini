declare module 'georedis' {
  ...
  export type NearbyObject = NearbyD | NearbyDC | NearbyDCH | NearbyC | NearbyCH | NearbyH

  export type NearbyReturnTypes = NearbyKey | NearbyObject

  export type GeoRedis = {
    delete(callback?: (err: Error) => void): void
    removeLocations(locationNames: string[], callback?: GeoCallback<boolean>): void
    addLocation(locationName: string, position: Point, callback?: GeoCallback<boolean>): void
